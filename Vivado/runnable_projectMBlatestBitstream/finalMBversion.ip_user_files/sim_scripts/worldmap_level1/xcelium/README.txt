...
#
# Generated by export_simulation on Wed Nov 28 21:48:51 -0800 2018
#
################################################################################
...
'-reset_run' switch to the './worldmap_level1.sh' script.

./worldmap_level1.sh -reset_run
...
./worldmap_level1.sh -noclean_files

For more information on the script, please type './worldmap_level1.sh -help'.
