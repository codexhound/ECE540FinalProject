...
#
# Generated by export_simulation on Thu Nov 29 03:24:17 -0800 2018
#
################################################################################
...
'-reset_run' switch to the './worldmap_gameover.sh' script.

./worldmap_gameover.sh -reset_run
...
./worldmap_gameover.sh -noclean_files

For more information on the script, please type './worldmap_gameover.sh -help'.
