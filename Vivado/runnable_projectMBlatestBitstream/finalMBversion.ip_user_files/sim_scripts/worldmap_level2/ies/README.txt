...
#
# Generated by export_simulation on Wed Nov 28 21:50:02 -0800 2018
#
################################################################################
...
'-reset_run' switch to the './worldmap_level2.sh' script.

./worldmap_level2.sh -reset_run
...
./worldmap_level2.sh -noclean_files

For more information on the script, please type './worldmap_level2.sh -help'.
