...
#
# Generated by export_simulation on Thu Nov 29 03:19:23 -0800 2018
#
################################################################################
...
'-reset_run' switch to the './worldmap_level3.sh' script.

./worldmap_level3.sh -reset_run
...
./worldmap_level3.sh -noclean_files

For more information on the script, please type './worldmap_level3.sh -help'.
