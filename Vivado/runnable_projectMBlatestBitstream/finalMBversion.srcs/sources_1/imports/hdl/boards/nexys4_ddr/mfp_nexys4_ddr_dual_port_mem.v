...
dual_port_world_map gameover_map(
        .clk(clk_out75),
        .addra(worldmap_addr),
        .addrb(vid_addr),
...
defparam gameover_map.MEMFILE = "Gameover.mem";

dual_port_world_map level1_map(
        .clk(clk_out75),
        .addra(worldmap_addr),
        .addrb(vid_addr),
...
defparam level1_map.MEMFILE = "level1.mem";

dual_port_world_map level2_map(
        .clk(clk_out75),
        .addra(worldmap_addr),
        .addrb(vid_addr),
...
defparam level2_map.MEMFILE = "level2.mem";

dual_port_world_map level3_map(
        .clk(clk_out75),
        .addra(worldmap_addr),
        .addrb(vid_addr),
...
defparam level3_map.MEMFILE = "level3.mem";
