...
HD_PWD='C:/Users/RampantVelcro/Desktop/Class/Fall2018/ECE540/ECE540FinalProject/Vivado/runnable_projectMBlatestBitstream/finalMBversion.runs/worldmap_gameover_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log worldmap_gameover.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source worldmap_gameover.tcl
