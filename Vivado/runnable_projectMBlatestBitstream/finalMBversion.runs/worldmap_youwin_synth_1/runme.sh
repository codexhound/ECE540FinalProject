...
HD_PWD='C:/Users/Chelsea/Documents/GitHub/ECE540FinalProject/Vivado/runnable_projectMBlatestBitstream/finalMBversion.runs/worldmap_youwin_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log worldmap_youwin.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source worldmap_youwin.tcl
