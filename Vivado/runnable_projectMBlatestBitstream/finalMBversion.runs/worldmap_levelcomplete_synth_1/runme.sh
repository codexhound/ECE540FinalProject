...
HD_PWD='C:/Users/Chelsea/Documents/GitHub/ECE540FinalProject/Vivado/runnable_projectMBlatestBitstream/finalMBversion.runs/worldmap_levelcomplete_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log worldmap_levelcomplete.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source worldmap_levelcomplete.tcl
